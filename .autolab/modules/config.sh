...
# config.sh - Configuration-related commands for AutoLab
# This module provides commands for configuring the AutoLab environment
...
function register_config_commands {
    ...
    # COMMAND_HELP["config:nucleus"]="Configure AutoLab Nucleus login"
