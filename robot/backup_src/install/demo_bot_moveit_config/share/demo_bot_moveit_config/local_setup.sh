...
: ${AMENT_CURRENT_PREFIX:="/home/robot/AutoLab/robot/ros_ws/src/install/demo_bot_moveit_config"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/demo_bot_moveit_config/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/demo_bot_moveit_config/environment/path.sh"
