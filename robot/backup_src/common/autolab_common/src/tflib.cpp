#include <autolab_common/tflib.hpp>
...
namespace tflib {
  ...
  tf2::Stamped<tf2::Transform> to_tf(autolab_msgs::msg::Odometry odom){//, std::string frame){
    tf2::Transform transform;
  ...
  bool transform_odometry(tf2_ros::Buffer* tf_buffer, autolab_msgs::msg::Odometry odom,
			  std::string new_frame_id, std::string new_child_frame_id, autolab_msgs::msg::Odometry* out_odom,
			  rclcpp::Duration polling_sleep_duration){
    try{
      *out_odom = transform_odometry(tf_buffer, odom, new_frame_id, new_child_frame_id, polling_sleep_duration);
    }
  ...
  // This can throw any exception that lookupTransform throws
  autolab_msgs::msg::Odometry transform_odometry(tf2_ros::Buffer* tf_buffer, autolab_msgs::msg::Odometry odom,
						  std::string new_frame_id, std::string new_child_frame_id,
						  rclcpp::Duration polling_sleep_duration){
    autolab_msgs::msg::Odometry out_odom;
    tf2::Stamped<tf2::Transform> transform_frame_id, transform_child_frame_id;
    geometry_msgs::msg::TransformStamped t;
