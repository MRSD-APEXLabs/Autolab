...
def inchesToMeters(inches: float) -> units.meter:
...
class TunerConstants:
    ...
    canbus = CANBus("AutoLab Canivore", "./logs/example.hoot")

    # Theoretical free speed (m/s) at 12 V applied output;
    # This needs to be tuned to your individual robot
    speed_at_12_volts: units.meters_per_second = 4.39

    # Every 1 rotation of the azimuth results in _couple_ratio drive motor turns;
    # This may need to be tuned to your individual robot
    _couple_ratio = 4.5

    _drive_gear_ratio = 7.03125
    ...
    _front_left_steer_motor_id = 30
    _front_left_encoder_id = 20
    _front_left_encoder_offset: units.rotation = -0.199462890625
    _front_left_steer_motor_inverted = False
    _front_left_encoder_inverted = False

    _front_left_x_pos: units.meter = inchesToMeters(9.98836614)
    _front_left_y_pos: units.meter = inchesToMeters(9.98832677)

    # Front Right
    _front_right_drive_motor_id = 12
    _front_right_steer_motor_id = 32
    _front_right_encoder_id = 22
    _front_right_encoder_offset: units.rotation = -0.009521484375
    _front_right_steer_motor_inverted = False
    _front_right_encoder_inverted = False

    _front_right_x_pos: units.meter = inchesToMeters(9.98836614)
    _front_right_y_pos: units.meter = inchesToMeters(-9.98832677)

    # Back Left
    _back_left_drive_motor_id = 11
    _back_left_steer_motor_id = 31
    _back_left_encoder_id = 21
    _back_left_encoder_offset: units.rotation = -0.36376953125
    _back_left_steer_motor_inverted = False
    _back_left_encoder_inverted = False

    _back_left_x_pos: units.meter = inchesToMeters(-9.98836614)
    _back_left_y_pos: units.meter = inchesToMeters(9.98832677)

    # Back Right
    _back_right_drive_motor_id = 13
    _back_right_steer_motor_id = 33
    _back_right_encoder_id = 23
    _back_right_encoder_offset: units.rotation = -0.082275390625
    _back_right_steer_motor_inverted = False
    _back_right_encoder_inverted = False

    _back_right_x_pos: units.meter = inchesToMeters(-9.98836614)
    _back_right_y_pos: units.meter = inchesToMeters(-9.98832677)
